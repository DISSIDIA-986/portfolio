...
const projects: Project[] = [
  ...
  {
    id: 18,
    title: "Fruit Ninja AI — Hand Gesture Game",
    description:
    ...
    imageUrl: "/images/projects/fruit-ninja-ai.svg",
    demoUrl: null,
    repoUrl: "https://github.com/DISSIDIA-986/fruit-ninja-ai",
    featured: true,
    category: "AI & Computer Vision",
    challenge: "Can AI hand tracking be fast and accurate enough for real-time gaming?",
  },
  {
    id: 5,
  ...
  // === NON-FEATURED (AI-relevant first) ===
  {
    id: 11,
